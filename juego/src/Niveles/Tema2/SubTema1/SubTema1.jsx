...
import Explicacion1 from "../../../Imagenes/Tema2/Videos/submodulo1_del_modulo2.mp4";
    ...
    return (
        <>
            <Box id={iden} className="imagen">
                ...
                {iden !== "JuegoSubTema2-1" && iden !== "Continuar" && (
                    <>
                ...
                {iden === "JuegoSubTema2-1" && (
                    <Trivia Terminado={Terminado} preguntas={preguntasAletorias.modulo2.SubTema1} comenzar={comenzar}/>
                )}
                {iden === "Continuar" && (
                    <>
