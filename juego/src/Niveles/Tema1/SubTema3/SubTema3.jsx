...
import Explicacion1 from "../../../Imagenes/Modulo1/Videos/Explicacion_1.mp4";
...
const SubTema3 = () => {
    const {setRuta, setRutaTema1, setPuntaje, preguntasAletorias, setTerminado} = useContext(GlobalContext);
    ...
    const continuar = (puntuajeJuego, tiempo, tiempoText) => {
        ...
        setPuntaje(prevState => ({
            ...
            modulo1: {
              ...prevState.modulo1,
              SubTema3: {puntuajeTotal: puntuajeJuego,tiempoTotal: tiempo}
            },
    ...
    return (
        <>
            <Box id={iden} className="imagen">
                ...
                {iden !== "JuegoSubTema1-3" && iden !== "Continuar" && (
                    <>
                ...
                {iden === 'JuegoSubTema1-3' && (
                    <JuegoMemoria comenzar={comenzar} rows={preguntasAletorias.modulo1.SubTema3} calcularPuntaje={continuar}/>
                )}
                {iden === "Continuar" && (
                    <>
