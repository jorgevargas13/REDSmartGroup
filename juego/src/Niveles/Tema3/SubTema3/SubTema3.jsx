...
import Explicacion1 from "../../../Imagenes/Tema3/Videos/submodulo3delmodulo3.mp4";
...
const SubTema3 = () => {
    const {setRuta, setPuntaje, setRutaTema3, setTerminado} = useContext(GlobalContext);
    ...
    const palabras = ["Dolor", "Enfermedad", "Urgencias", "Tratamiento", "Paro"];
    ...
    return (
        <>
            <Box id={iden} className="imagen">
                ...
                {iden !== "JuegoSubTema3-3" && iden !== "Continuar" && (
                    <>
