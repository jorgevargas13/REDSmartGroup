...
import Explicacion1 from "../../../Imagenes/Tema3/Videos/submodulo1delmodulo3.mp4";
import Prueba from "../../../Imagenes/Modulo1/Img/PRUEBA.png";
import Instrucciones1 from "../../../Imagenes/Modulo1/Img/Instrucciones_2.png";
import img1 from "../../../Imagenes/Tema2/Img/img1.jpg";
import img2 from "../../../Imagenes/Tema2/Img/img2.avif";
import JuegoArrastrarSoltar from "../../Juegos/JuegoArrastrarSoltar/JuegoArrastrarSoltar";
import { Tooltip } from "@mui/material";

const SubTema1 = () => {
    const {setRuta, setRutaTema3, setPuntaje, setTerminado} = useContext(GlobalContext);
    ...
    const Terminado = (arreglo, OrdenCorrecto, tiempo, tiempoText) => {
        if (arreglo[0] !== "" && arreglo[1] !== ""){
            ...
            setPuntaje(prevState => ({
                ...
                modulo3: {
                    ...prevState.modulo3,
                    SubTema1: {puntuajeTotal: puntuajeJuego,tiempoTotal: tiempo}
                },
    ...
    return (
        <>
            <Box id={iden} className="imagen">
                ...
                {iden !== "JuegoSubTema3-1" && iden !== "Continuar" && (
                    <>
